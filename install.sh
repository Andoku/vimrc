...
git clone https://github.com/AndrewRadev/linediff.vim.git $HOME/.vim_runtime/my_plugins
echo "Installing vim-cpp-modern plugin.."
git clone https://github.com/bfrg/vim-cpp-modern.git $HOME/.vim_runtime/my_plugins
